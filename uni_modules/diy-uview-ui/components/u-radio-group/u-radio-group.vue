<template>
	<view class="u-radio-group flex flex-wrap" :class="[uFromData.inputAlign == 'right' ? 'flex-end' : '',wrapClass]">
		<slot></slot>
	</view>
</template>
 ...
 * @property {String} active-color 选中时的颜色，应用到所有子Radio组件（默认#19be6b）
