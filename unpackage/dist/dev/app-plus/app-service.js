...
(function(vue, shared) {
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/components/diy-noticebar/diy-noticebar.vue"]]);
  const _sfc_main$l = {
    name: "u-icon",
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$k], ["__scopeId", "data-v-305117c1"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-icon/u-icon.vue"]]);
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__scopeId", "data-v-42f09606"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-input/u-input.vue"]]);
  function _extends() {
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__scopeId", "data-v-e2d0cb75"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-form-item/u-form-item.vue"]]);
  ...
  const MY_CONTRIBUTION_URL = SHARE_URL + "/my-contribute";
  const MY_EXCHANGE_URL = SHARE_URL + "/myExchange";
  const MYVALUE = USER_URL + "/myValue";
  ...
  const _sfc_main$i = {
    ...
    methods: {
      ...
      async getNotice() {
        ...
        formatAppLog("log", "at pages/index/index.vue:160", "通知文本：" + res2.data.content);
        formatAppLog("log", "at pages/index/index.vue:161", "通知状态：" + res2.data.showFlag);
        this.notice = res2.data.content;
        this.showFlag = res2.data.showFlag;
      },
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_diy_noticebar = resolveEasycom(vue.resolveDynamicComponent("diy-noticebar"), __easycom_0$5);
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      ...
      vue.createElementVNode("view", { class: "flex diygw-col-24 flex-direction-column" }, [
        ...
        vue.createElementVNode("view", { class: "" }, [
          $data.tabsIndex == 0 ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "flex diygw-col-24 noticebar-clz" }, [
              vue.createVNode(_component_diy_noticebar, {
                ...
                content: vue.withCtx(() => [
                  $data.showFlag ? (vue.openBlock(), vue.createElementBlock(
                    "text",
                    {
                      key: 0,
            ...
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.shares, (share, index) => {
                return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                  vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex1-clz" }, [
                    vue.createElementVNode("view", { class: "flex diygw-col-24 justify-around avatar-clz" }, [
                      vue.createElementVNode("view", { class: "diygw-avatar radius-md bg-none" }, [
                        vue.createElementVNode("image", {
                          mode: "aspectFill",
                          class: "diygw-avatar-img radius-md",
                          src: share.cover
                        }, null, 8, ["src"]),
                        share.isOriginal ? (vue.openBlock(), vue.createElementBlock("text", {
                          key: 0,
                    ...
                    vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-clz" }, [
                      vue.createElementVNode(
                        ...
                        vue.toDisplayString(share.title),
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode(
                        ...
                        vue.toDisplayString(share.summary),
                        1
                        /* TEXT */
                      )
                    ]),
                    vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex3-clz" }, [
                      vue.createElementVNode(
                        "view",
                        { class: "diygw-col-24 text3-clz" },
                        vue.toDisplayString(share.price) + " 积分 ",
                        1
                        /* TEXT */
                      ),
                      share.downloadUrl ? (vue.openBlock(), vue.createElementBlock("view", {
                        key: 0,
                        class: "diygw-col-24",
                        onClick: ($event) => $options.gotoDetail(share.id)
                      }, " 下载 ", 8, ["onClick"])) : (vue.openBlock(), vue.createElementBlock("view", {
                        key: 1,
                        class: "diygw-col-24",
                        onClick: ($event) => $options.gotoExchange(share.id)
                      }, " 兑换 ", 8, ["onClick"]))
                    ])
                  ]),
          ...
          $data.tabsIndex == 1 ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex8-clz" }, [
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex6-clz" }, [
                vue.createElementVNode("view", { class: "diygw-col-24 red text8-clz diygw-text-xl" }, " 01 "),
                vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex7-clz" }, [
                  vue.createElementVNode("view", { class: "diygw-text-line1 diygw-col-24 text9-clz" }, " 积分获得方式 "),
                  vue.createElementVNode("view", { class: "flex diygw-col-24 line2-clz" }, [
                    vue.createElementVNode("view", {
                      class: "diygw-pzx",
                      style: { "border-bottom": "2px solid #f3b23f" }
                    })
                  ])
                ])
              ]),
              vue.createVNode(_component_u_form_item, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_u_input, {
                    ...
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.textarea = $event),
                    type: "textarea"
                  }, null, 8, ["modelValue"])
                ]),
                _: 1
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__scopeId", "data-v-1cf27b2a"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/index/index.vue"]]);
  const _sfc_main$h = {
    name: "u-radio",
    emits: ["change"],
    props: {
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__scopeId", "data-v-088e54f1"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-radio/u-radio.vue"]]);
  const _sfc_main$g = {
    name: "u-radio-group",
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__scopeId", "data-v-abc7d820"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-radio-group/u-radio-group.vue"]]);
  const _sfc_main$f = {
    data() {
      return {
        title: "美食图鉴大赏",
    ...
    methods: {
      async submit() {
        ...
        formatAppLog("log", "at pages/submission/submission.vue:101", res2);
        if (res2 === 1) {
          uni.showModal({
            title: "提示",
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_radio = resolveEasycom(vue.resolveDynamicComponent("u-radio"), __easycom_0$3);
    const _component_u_radio_group = resolveEasycom(vue.resolveDynamicComponent("u-radio-group"), __easycom_1$1);
    const _component_u_form_item = resolveEasycom(vue.resolveDynamicComponent("u-form-item"), __easycom_2);
    const _component_u_input = resolveEasycom(vue.resolveDynamicComponent("u-input"), __easycom_3);
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center" }, [
        vue.createElementVNode("view", { class: "diygw-col-24 text-clz" }, " 说明：投稿审核通过后会有积分奖励；资源被下载会有积分奖励；提交的资源不得包含广告、侵权信息，百度盘地址建议有密码。 ")
      ]),
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center" }, [
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center" }, [
          vue.createVNode(_component_u_form_item, {
            class: "diygw-col-24",
            label: "来源",
            prop: "radio"
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_u_radio_group, {
                class: "flex flex-wrap diygw-col-24 justify-between",
                ...
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList($data.radioDatas, (radioitem, radioindex) => {
                      return vue.openBlock(), vue.createBlock(_component_u_radio, {
                        ...
                        default: vue.withCtx(() => [
                          vue.createTextVNode(
                            vue.toDisplayString(radioitem.label),
                            1
                            /* TEXT */
                          )
                        ]),
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.author = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.summary = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              class: "",
              placeholder: "请输入封面图网址",
              modelValue: $data.cover,
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $data.cover = $event),
              type: "cover"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
        ...
        vue.createVNode(_component_u_form_item, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_u_input, {
              ...
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $data.downloadUrl = $event),
              type: "text"
            }, null, 8, ["focus", "modelValue"])
          ]),
          _: 1
  ...
  const PagesSubmissionSubmission = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-5b3c6644"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/submission/submission.vue"]]);
  const _sfc_main$e = {
    data() {
      return {
        //用户全局信息
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      !$data.userInfo ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "flex flex-wrap diygw-col-24 flex-direction-column"
      }, [
        vue.createElementVNode("view", { class: "flex diygw-col-24 justify-center avatar-clz" }, [
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center" }, [
          vue.createElementVNode("view", { class: "diygw-col-5 text-clz" }, " 登录，享受技术之旅 "),
          vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex2-clz" }, [
            vue.createElementVNode("view", { class: "flex diygw-col-8" }, [
              vue.createElementVNode("button", {
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center" }, [
          ...
          vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex2-clz" }, [
            vue.createElementVNode("view", { class: "flex diygw-col-8" }, [
              vue.createElementVNode("button", { class: "diygw-btn blue radius-xs flex-sub margin-xs button1-button-clz" }, "签到")
            ]),
            vue.createElementVNode("view", { class: "flex diygw-col-8" }, [
              vue.createElementVNode("button", {
                onClick: _cache[1] || (_cache[1] = (...args) => $options.logout && $options.logout(...args)),
                class: "diygw-btn blue radius-xs flex-sub margin-xs button-button-clz"
              }, "退出")
            ])
          ])
        ]),
        $data.userInfo ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
          vue.createElementVNode("view", {
            class: "flex flex-wrap diygw-col-24",
            onClick: _cache[2] || (_cache[2] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
            "data-type": "page",
            "data-url": "/pages/exchange/myexchange"
          }, [
            vue.createElementVNode("view", { class: "diygw-col-22 text2-clz" }, " 我的兑换 "),
            vue.createElementVNode("image", {
              src: "/static/yjt.png",
              class: "response diygw-col-2 image-clz",
              mode: "widthFix"
            })
          ]),
          vue.createElementVNode("view", { class: "flex diygw-col-24" }, [
          ...
          vue.createElementVNode("view", {
            ...
            "data-type": "page",
            "data-url": "/pages/point/pointdetail"
          }, [
            vue.createElementVNode("view", { class: "diygw-col-22 text5-clz" }, " 积分明细 "),
            vue.createElementVNode("image", {
              src: "/static/yjt.png",
              class: "response diygw-col-2 image3-clz",
              mode: "widthFix"
            })
          ]),
          vue.createElementVNode("view", { class: "flex diygw-col-24" }, [
          ...
          vue.createElementVNode("view", {
            ...
            "data-type": "page",
            "data-url": "/pages/submission/mysubmission"
          }, [
            vue.createElementVNode("view", { class: "diygw-col-22 text4-clz" }, " 我的投稿 "),
            vue.createElementVNode("image", {
              src: "/static/yjt.png",
              class: "response diygw-col-2 image2-clz",
              mode: "widthFix"
            })
          ]),
          vue.createElementVNode("view", { class: "flex diygw-col-24" }, [
          ...
          $data.userInfo.roles === "admin" ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            "data-type": "page",
            "data-url": "/pages/audit/waitAudit"
          }, [
            vue.createElementVNode("view", { class: "diygw-col-22 text3-clz" }, " 审核投稿 "),
            vue.createElementVNode("image", {
              src: "/static/yjt.png",
              class: "response diygw-col-2 image1-clz",
              mode: "widthFix"
            })
          ])) : vue.createCommentVNode("v-if", true)
        ])) : vue.createCommentVNode("v-if", true)
  ...
  const PagesMyMy = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__scopeId", "data-v-2f1ef635"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/my/my.vue"]]);
  const _sfc_main$d = {
    name: "u-form",
    props: {
      // 当前form的需要验证字段的集合
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-590dd7e2"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-form/u-form.vue"]]);
  const _sfc_main$c = {
    data() {
      return {
        //用户全局信息
    ...
    methods: {
      ...
      async login() {
        ...
        const res2 = await request(LOGIN_URL, "POST", loginDTO);
        formatAppLog("log", "at pages/login/login.vue:94", res2);
        if (res2.success == true) {
          uni.showToast({
            title: "登录成功"
          });
          formatAppLog("log", "at pages/login/login.vue:99", JSON.stringify(res2.data.user) + "&&&&&&&&");
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_form = resolveEasycom(vue.resolveDynamicComponent("u-form"), __easycom_0$2);
    const _component_u_input = resolveEasycom(vue.resolveDynamicComponent("u-input"), __easycom_3);
    const _component_u_form_item = resolveEasycom(vue.resolveDynamicComponent("u-form-item"), __easycom_2);
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex-clz" }, [
        ...
        vue.createElementVNode("view", { class: "flex diygw-col-10 justify-center avatar-clz" }, [
          vue.createElementVNode("view", { class: "diygw-avatar avatar-avatar xl margin-md bg-none" }, [
            vue.createElementVNode("image", {
              mode: "aspectFit",
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center" }, [
          ...
          vue.createElementVNode("view", { class: "flex diygw-col-7 justify-center button-clz" }, [
            vue.createElementVNode("button", {
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-e4e4508d"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/login/login.vue"]]);
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "" }, [
      vue.createElementVNode(
        "view",
        {
          class: vue.normalizeClass(["u-navbar", [$props.isFixed ? "u-navbar-fixed" : "", $props.borderBottom ? "u-border-bottom" : "", $props.bgColor]]),
        ...
        [
          ...
          vue.createElementVNode(
            ...
            [
              $props.isBack || $props.isHome ? (vue.openBlock(), vue.createElementBlock(
                "view",
                {
                  key: 0,
                  class: vue.normalizeClass(["flex align-center", $props.isCapsule ? "diy-navbar-solid" : "diy-navbar-default"])
                },
                [
                  ...
                  $props.isHome && $props.isBack ? (vue.openBlock(), vue.createElementBlock(
                    "view",
                    {
                      key: 1,
                      class: "diy-navbar-split",
                      style: vue.normalizeStyle({
                        borderLeft: "1px solid " + $props.backIconColor
                      })
                    },
                    null,
                    4
                  ...
                  $props.isHome ? (vue.openBlock(), vue.createElementBlock("view", {
                    key: 2,
                    class: "u-back-wrap u-back-home",
                    onClick: _cache[1] || (_cache[1] = (...args) => $options.getHome && $options.getHome(...args))
                  }, [
                    vue.createElementVNode("view", { class: "u-icon-wrap" }, [
                      vue.createVNode(_component_u_icon, {
                        name: "home",
              ...
              !$props.isSlot && ($props.title || $props.isSlotTitle) ? (vue.openBlock(), vue.createElementBlock(
                "view",
                {
                  key: 1,
                ...
                [
                  $props.isSlotTitle ? (vue.openBlock(), vue.createElementBlock(
                    "view",
                    {
                      key: 0,
      ...
      vue.createCommentVNode(" 解决fixed定位后导航栏塌陷的问题 "),
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-fa2f1165"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-navbar/u-navbar.vue"]]);
  const _sfc_main$a = {
    name: "u-loading",
    props: {
      // 动画的类型
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-542498e5"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-loading/u-loading.vue"]]);
  const _sfc_main$9 = {
    name: "u-switch",
    emits: ["update:modelValue", "input", "change"],
    props: {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-7833cded"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/uni_modules/diy-uview-ui/components/u-switch/u-switch.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {
        shareId: "",
    ...
    onLoad(option) {
      ...
      formatAppLog("log", "at pages/audit/resourceAudit.vue:67", this.shareId);
      this.getShare();
    },
    methods: {
      async getShare() {
        ...
        formatAppLog("log", "at pages/audit/resourceAudit.vue:80", res2.data);
        this.share = res2.data.share;
        formatAppLog("log", "at pages/audit/resourceAudit.vue:82", this.share);
        this.nickname = res2.data.nickname;
        this.avatarUrl = res2.data.avatarUrl;
      },
      changeAuditStatus(evt) {
        formatAppLog("log", "at pages/audit/resourceAudit.vue:87", this.showFlag);
      },
      changeShowFlag(evt) {
        formatAppLog("log", "at pages/audit/resourceAudit.vue:90", this.auditStatus);
      },
      async submit() {
        uni.showLoading({
          title: "审核中"
        });
        await request(AUDIT_URL + `/${this.shareId}`, "POST", {
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_switch = resolveEasycom(vue.resolveDynamicComponent("u-switch"), __easycom_1);
    const _component_u_form_item = resolveEasycom(vue.resolveDynamicComponent("u-form-item"), __easycom_2);
    const _component_u_input = resolveEasycom(vue.resolveDynamicComponent("u-input"), __easycom_3);
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      vue.createVNode(_component_u_navbar, {
        ...
        titleColor: "inherit",
        bgColor: "red",
        backTextStyle: { color: "inherit" },
        isHome: false,
        isBack: true
      }, {
        title: vue.withCtx(() => [
          vue.createTextVNode(" 资源审核 ")
        ]),
        _: 1
        /* STABLE */
      }),
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex-clz" }, [
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex1-clz" }, [
          vue.createElementVNode(
            "view",
            { class: "diygw-col-7 text-clz" },
            " 作者：" + vue.toDisplayString($data.nickname),
            1
            /* TEXT */
          ),
          vue.createElementVNode(
            "view",
            { class: "diygw-col-7 text4-clz" },
            " 发布人：" + vue.toDisplayString($data.share.author),
            1
            /* TEXT */
          ),
          vue.createElementVNode(
            "view",
            { class: "diygw-col-5 text3-clz" },
            " 积分：" + vue.toDisplayString($data.share.price),
            1
            /* TEXT */
          ),
          $data.share.isOriginal ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "diygw-col-5 text2-clz"
          }, " 来源：原创 ")) : (vue.openBlock(), vue.createElementBlock("view", {
            key: 1,
            class: "diygw-col-5 text2-clz"
          }, " 来源：转载 "))
        ]),
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex2-clz" }, [
          vue.createElementVNode("image", {
            ...
            class: "response diygw-col-24 image-clz",
            mode: "widthFix"
          }, null, 8, ["src"]),
          vue.createElementVNode(
            "view",
            { class: "diygw-col-24 text5-clz" },
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column" }, [
          ...
          default: vue.withCtx(() => [
            vue.createElementVNode("view", { class: "flex diygw-col-24 justify-end" }, [
              vue.createVNode(_component_u_switch, {
                ...
                inactiveValue: 0,
                activeColor: "#0081ff",
                onClick: $options.changeAuditStatus,
        ...
        vue.createVNode(_component_u_form_item, {
          class: "diygw-col-24 switch1-clz",
          label: "立即发布",
          prop: "switch1"
        }, {
          default: vue.withCtx(() => [
  ...
  const PagesAuditResourceAudit = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-a1670519"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/audit/resourceAudit.vue"]]);
  const _sfc_main$7 = {
    data() {
      return {
        shares: []
    ...
    methods: {
      async getShares() {
        ...
        formatAppLog("log", "at pages/audit/waitAudit.vue:45", res2);
        setTimeout(() => {
          uni.hideLoading();
        }, 1e3);
        this.shares = res2.data;
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      ...
      (vue.openBlock(true), vue.createElementBlock(
        ...
        vue.renderList($data.shares, (share, index) => {
          return vue.openBlock(), vue.createElementBlock("view", {
            key: index,
            onClick: ($event) => $options.auditDetail(share.id),
            class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex2-clz"
          }, [
            vue.createElementVNode("view", { class: "flex diygw-col-24 justify-around avatar1-clz" }, [
              vue.createElementVNode("view", { class: "diygw-avatar radius-md bg-none" }, [
                vue.createElementVNode("image", {
                  mode: "aspectFill",
                  class: "diygw-avatar-img radius-md",
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex4-clz" }, [
              vue.createElementVNode(
                "view",
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-4 flex1-clz" }, [
              vue.createElementVNode("view", { class: "diygw-col-15 text-clz" }, " 去审核 "),
              vue.createElementVNode("image", {
                src: "/static/yjt.png",
                class: "response diygw-col-2 image-clz",
                mode: "widthFix"
  ...
  const PagesAuditWaitAudit = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-f47c6e5a"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/audit/waitAudit.vue"]]);
  const _sfc_main$6 = {
    data() {
      return {
        url: ""
  ...
  const PagesWebview = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/webview.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        share: {},
    ...
    onLoad(option) {
      this.id = option.id;
      formatAppLog("log", "at pages/exchange/exchange.vue:52", this.id);
    },
    methods: {
      async getShare() {
        let id = this.id;
        ...
        formatAppLog("log", "at pages/exchange/exchange.vue:65", res2.data);
        this.share = res2.data.share;
        this.nickname = res2.data.nickname;
        this.avatarUrl = res2.data.avatarUrl;
      },
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-end flex3-clz" }, [
        vue.createElementVNode(
          "view",
          { class: "diygw-col-8 text6-clz" },
          " 积分：" + vue.toDisplayString($data.share.price),
          1
          /* TEXT */
        ),
        vue.createElementVNode("view", { class: "flex diygw-col-8 button-clz" }, [
          vue.createElementVNode("button", {
            onClick: _cache[0] || (_cache[0] = (...args) => $options.exchange && $options.exchange(...args)),
            "data-type": "tip",
            "data-tip": "兑换成功！",
            class: "diygw-btn red radius-xs flex-sub margin-xs button-button-clz"
          }, "兑换")
  ...
  const PagesExchangeExchange = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-ea8424b3"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/exchange/exchange.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        share: null,
    ...
    onLoad(option) {
      this.id = option.id;
      formatAppLog("log", "at pages/detail/detail.vue:54", this.id);
      this.getShare();
    },
    methods: {
      async getShare() {
        ...
        formatAppLog("log", "at pages/detail/detail.vue:68", res2.data);
        this.share = res2.data.share;
        this.nickname = res2.data.nickname;
        this.avatarUrl = res2.data.avatarUrl;
      },
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      ...
      vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column flex-clz" }, [
        ...
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex1-clz" }, [
          ...
          vue.createCommentVNode(" 待处理，显示：原创or转载 ")
        ]),
        vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 justify-center flex2-clz" }, [
          vue.createElementVNode("image", {
            src: $data.share.cover,
      ...
      vue.createElementVNode("view", { class: "flex diygw-col-24" }, [
        vue.createElementVNode("button", {
          onClick: _cache[0] || (_cache[0] = (...args) => _ctx.navigateTo && _ctx.navigateTo(...args)),
          "data-type": "copy",
          "data-copy": $data.share.downloadUrl,
          "data-tip": "已成功复制！",
          class: "diygw-btn grey radius-xs flex-sub margin-xs button-button-clz"
        }, "复制下载链接", 8, ["data-copy"]),
        vue.createCommentVNode(" 复制，待解决 ")
      ]),
      vue.createElementVNode("view", { class: "clearfix" })
    ]);
  }
  const PagesDetailDetail = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-eca06f3c"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/detail/detail.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        shares: [],
    ...
    methods: {
      async getShares(init) {
        ...
        let res2 = await request(MY_CONTRIBUTION_URL, "GET", {
          pageNo: this.pageNo,
          pageSize: this.pageSize
        });
        setTimeout(() => {
        ...
        let shares = res2.data;
        this.shares = shares.map(function(item) {
          let res3 = {};
          switch (item.auditStatus) {
            case "NOT_YET":
              res3.auditStatus = "尚未审核";
              break;
            case "PASS":
              res3.auditStatus = "审核通过";
              break;
            case "REJECT":
              res3.auditStatus = "审核被拒";
              break;
          }
          res3.id = item.id;
          res3.title = item.title;
          res3.cover = item.cover;
          res3.summary = item.summary;
          setTimeout(() => {
            uni.hideLoading();
          }, 100);
          return res3;
      ...
      (vue.openBlock(true), vue.createElementBlock(
        ...
        vue.renderList($data.shares, (share, index) => {
          return vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-8 flex4-clz" }, [
              vue.createElementVNode(
                "view",
                { class: "diygw-col-9 text4-clz" },
                vue.toDisplayString(share.title),
                1
                /* TEXT */
              ),
              vue.createElementVNode(
                "view",
                { class: "diygw-text-line2 diygw-col-13 text5-clz" },
                vue.toDisplayString(share.summary),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-8 flex1-clz" }, [
              vue.createElementVNode(
                "view",
                { class: "diygw-col-10 text-clz" },
                vue.toDisplayString(share.auditStatus),
                1
                /* TEXT */
              ),
              vue.createElementVNode("image", {
                src: "/static/yjt.png",
                class: "response diygw-col-1 image-clz",
                mode: "widthFix"
              })
            ])
          ]);
  ...
  const PagesSubmissionMysubmission = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-2ddb0ff7"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/submission/mysubmission.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        shares: []
    ...
    methods: {
      async getMyExchange() {
        let res2 = await request(MY_EXCHANGE_URL, "GET", {});
        formatAppLog("log", "at pages/exchange/myexchange.vue:91", res2);
        this.shares = res2.data;
      },
      gotoDetail(id) {
        uni.navigateTo({
                ...
                vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex1-clz" }, [
                  ...
                  vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-24 flex-direction-column justify-center flex3-clz" }, [
                    ...
                    share.downloadUrl ? (vue.openBlock(), vue.createElementBlock("view", {
                      ...
                      key: 1,
                      class: "diygw-col-24",
                      onClick: ($event) => _ctx.gotoExchange(share.id)
                    }, " 兑换 ", 8, ["onClick"]))
                  ])
                ]),
                vue.createElementVNode("view", { class: "flex diygw-col-24" }, [
  ...
  const PagesExchangeMyexchange = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-918def93"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/exchange/myexchange.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        myValues: []
    ...
    methods: {
      async getValues() {
        let res2 = await request(MYVALUE, "GET", {});
        formatAppLog("log", "at pages/point/pointdetail.vue:49", res2);
        this.myValues = res2.data;
      }
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container container25504" }, [
      ...
      (vue.openBlock(true), vue.createElementBlock(
        vue.Fragment,
        null,
        vue.renderList($data.myValues, (myValue, index) => {
          return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
            myValue.value < 0 ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "flex flex-wrap diygw-col-24 justify-end flex-clz"
            }, [
              vue.createElementVNode("text", { class: "flex icon diygw-col-2 icon-clz diy-icon-youhuiquan" }),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-19" }, [
                vue.createElementVNode(
                  "view",
                  { class: "diygw-col-12 mg" },
                  vue.toDisplayString(myValue.createTime),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode("view", { class: "diygw-col-3" }, " —— "),
                vue.createElementVNode(
                  "view",
                  { class: "diygw-col-5" },
                  vue.toDisplayString(myValue.value),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("text", { class: "flex icon1 diygw-col-2 icon1-clz diy-icon-pullright" })
            ])) : (vue.openBlock(), vue.createElementBlock("view", {
              key: 1,
              class: "flex flex-wrap diygw-col-24 justify-end flex2-clz"
            }, [
              vue.createElementVNode("text", { class: "flex icon2 diygw-col-2 icon2-clz diy-icon-shouru" }),
              vue.createElementVNode("view", { class: "flex flex-wrap diygw-col-19" }, [
                vue.createElementVNode(
                  "view",
                  { class: "diygw-col-12 mg" },
              ...
              vue.createElementVNode("text", { class: "flex icon3 diygw-col-2 icon3-clz diy-icon-pullright" })
            ]))
          ]);
        }),
        128
  ...
  const PagesPointPointdetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-cf3148d5"], ["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/pages/point/pointdetail.vue"]]);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/submission/submission", PagesSubmissionSubmission);
  __definePage("pages/my/my", PagesMyMy);
  __definePage("pages/login/login", PagesLoginLogin);
  __definePage("pages/audit/resourceAudit", PagesAuditResourceAudit);
  __definePage("pages/audit/waitAudit", PagesAuditWaitAudit);
  ...
  __definePage("pages/submission/mysubmission", PagesSubmissionMysubmission);
  __definePage("pages/exchange/myexchange", PagesExchangeMyexchange);
  __definePage("pages/point/pointdetail", PagesPointPointdetail);
  const _sfc_main = {
    globalData: {
      userInfo: null,
      tabBar: ["pages/index/index", "/pages/submission/submission", "/pages/my/my"],
      homePage: "/pages/index/index",
      pages: ["pages/index/index", "/pages/submission/submission", "/pages/my/my", "/pages/login/login"],
      userData: {}
    }
  };
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/wangkaijie/Desktop/uniapp-myapp/App.vue"]]);
  ...
  class Tools {
    ...
    getCurrentDate() {
      return this.formatDate(/* @__PURE__ */ new Date(), "YYYY-mm-dd");
    }
    getCurrentTime() {
      return this.formatDate(/* @__PURE__ */ new Date(), "HH:MM");
    }
    addDays(days) {
    ...
    getCurrentDateTime() {
      return this.formatDate(/* @__PURE__ */ new Date(), "YYYY-mm-dd HH:MM:SS");
    }
    /**
     * 返回指定范围内的一个整数
     * @param  {Number} min
     ...
     */
    randFilename(file) {
      return this.randString(this.rand(10, 100)) + Date.parse(/* @__PURE__ */ new Date()) + "." + this.getFilenameExt(file);
    }
    /**
     * 判断某个元素是否为字符串
     * @param  {String}  value
    ...
    setInterceptors() {
      this.interceptors = [{
        request: (request2) => {
          ...
          request2.requestTimestamp = (/* @__PURE__ */ new Date()).getTime();
          if (Session.getToken()) {
        ...
        response: (response) => {
          ...
          response.responseTimestamp = (/* @__PURE__ */ new Date()).getTime();
